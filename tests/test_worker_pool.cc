...
/*   Updated: 2026/03/15 15:53:21 by ilyanar          ###   LAUSANNE.ch       */
/*                                                                            */
/* ************************************************************************** */
...
int testWorkerPool() {
	{
		...
		lpp::unique_chrono chrono("worker with 10 thread");
	...
	{
		lpp::worker_pool pool(1);
		lpp::unique_chrono chrono("worker with 1 thread");
